...
const quizArray = [
    {
        ...
        options: ["cascading style sheet", "curved style sheet", "cascade style standard", "cascadian style standard"],
        correct: "cascading style sheet",
    },
    {
        id: "1",
        question: "What does HTTP stand for?",
        options: ["Hyper text transfer protocol", "Header text transfer protocol", "hyper text transmission protocol", "hyper text transfer process"],
